...
<div class="dropdown">
    ...
    <div class="dropdown-menu" style="padding: 20px;" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item active" style="font-weight: bolder">Alle modellen</a>
        <hr>
    ...
    <div class="filterDiv hatchback">
        ...
        <hr>
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 30.556,00</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 31.775,00</p>
                <a href="#">
    ...
    <div class="filterDiv limousine">
        ...
        <hr>
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 33.212,00</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 42.347,00</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 57.807,59</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <a href="#">
                <h2 class="rowTitleBox emptySpace">S-Klasse Limousine</h2>
                </a>
                <p class="p2 text-muted">vanaf € 112.166,16</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/S-Klasse/s-klasse-limousine.png">
                </a>
            </div>
            <div class="col-4 rowBox" style="display: inline-block;">
                <p class="btnRounding">Ook als Plug-in Hybride</p>
    ...
    <div class="filterDiv estate">
        ...
        <hr>
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 38.672,00</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 45.066,00</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 59.807,92</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                <p class="emptySpace"></p>
                <a href="#">
                <h2 class="rowTitleBox emptySpace">E-Klasse Estate All-Terrain</h2>
                </a>
                <p class="p2 text-muted">vanaf € 77.075,88</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/E-Klasse/e-klasse-estate-allterrain.png">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="filterDiv coupe">
        ...
        <hr>
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 37.090,00</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 46.078,00</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/C-Klasse/c-klasse-coupe.png">
                </a>
            </div>
            <div class="col-4 rowBox" style="display: inline-block;">
                <p class="emptySpace"></p>
                ...
                <p class="p2 text-muted">vanaf € 60.578,00</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/E-Klasse/e-klasse-coupe.png">
                </a>
            </div>
            <div class="col-4 rowBox" style="display: inline-block;">
                <p class="emptySpace"></p>
                ...
                <p class="p2 text-muted">vanaf € 72.902,12</p>
                <a href="#">
    ...
    <div class="filterDiv cabrio">
        ...
        <hr>
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 57.334,00</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/C-Klasse/c-klasse-cabrio.png">
                </a>
            </div>
            <div class="col-4 rowBox" style="display: inline-block;">
                <p class="emptySpace"></p>
                ...
                <p class="p2 text-muted">vanaf € 67.088,00</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/E-Klasse/e-klasse-cabrio.png">
                </a>
            </div>
            <div class="col-4 rowBox" style="display: inline-block;">
                <p class="emptySpace"></p>
                ...
                <p class="p2 text-muted">vanaf € 235.186,00</p>
                <a href="#">
    ...
    <div class="filterDiv suv">
        ...
        <hr>
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 47.193,00</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 49.994,00</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/GLB-Klasse/glb-suv.png">
                </a>
            </div>
            <div class="col-4 rowBox" style="display: inline-block;">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 63.260,50</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 61.819,68</p>
                <a href="#">
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                ...
                <p class="p2 text-muted">vanaf € 128.597,24</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/GLS-Klasse/gls-suv.png">
                </a>
            </div>
            <div class="col-4 rowBox" style="display: inline-block;">
                <p class="emptySpace"></p>
                ...
                <p class="p2 text-muted">vanaf € 176.907,45</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/G-Klasse/g-klasse-suv.png">
                </a>
            </div>
            <div class="col-4 rowBox" style="display: inline-block;">
                <p class="emptySpace"></p>
    ...
    <div class="filterDiv mpv">
        ...
        <hr>
            ...
            <div class="col-4 rowBox" style="display: inline-block;">
                <p class="emptySpace"></p>
                <a href="#">
                <h2 class="rowTitleBox">V-Klasse</h2>
                </a>
                <p class="p2 text-muted">vanaf € 72.645,00</p>
                <a href="#">
                <img class="rowCarImg" src="img/Mercedes/V-Klasse/v-klasse.png">
                </a>
            </div>
            <div class="col-4 rowBox" style="display: inline-block;">
